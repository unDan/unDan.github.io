...
// Основные настройки:
$recipients = ['elgoogecaf@gmail.com']; // Получатели писем
...
$smtp_username = 'alienterrorblade@gmail.com'; // Почтовый ящик, с которого будут отправляться письма
$smtp_password = 'Trollface1'; // Пароль почтового ящика, с которого будут отправляться письма
