...
// Основные настройки:
$recipients = ['zibiluev@mail.ru']; // Получатели писем
...
$smtp_username = 'warfaceawmtest1@mail.ru'; // Почтовый ящик, с которого будут отправляться письма
$smtp_password = 'Starwarsempireatwar'; // Пароль почтового ящика, с которого будут отправляться письма
